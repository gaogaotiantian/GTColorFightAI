...
var gameStatus = {"cellSize":20, 'cells':[], 'info':[], 'selectId': -1, 'globalDirty': false, 'maxVal':20, 'minVal':0}
var once = {'once':0};
var lastUpdate = 0;
var fullInfo = false;
...
DrawGame = function() {
    ...
    var currMaxVal = gameStatus['maxVal'];
    var currMinVal = gameStatus['minVal'];
    var maxVal = 1;
    var minVal = 10000;
    for (idx in cells) {
        var cell = cells[idx];
        ...
        if (true || gDirty || cell['dirty'] || cell['c'] != 0 ||
    ...
    gameStatus['maxVal'] = maxVal;
    gameStatus['minVal'] = minVal;
    if (gDirty) {
